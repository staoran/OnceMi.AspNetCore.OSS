...
namespace EasyLink.Storage
{
    ...
    public abstract class BaseOSSService
    {
        ...
        protected internal virtual string FormatObjectName(string objectName)
        {
        ...
        protected internal virtual async Task<string> PresignedObjectAsync(string bucketName
            , string objectName
            , int expiresInt
